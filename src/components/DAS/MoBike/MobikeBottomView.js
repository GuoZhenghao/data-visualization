...
import styles from './MobikeBottomView.less';

class MobikeBottomView extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.dispatch({
            type: 'mobikeModel/getMobikeBottomChartsData'
        })
    }
...
export default connect(mapStateToProps)(MobikeBottomView);
