...
import styles from './ENVBottomView.less';

class ENVLeftView extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.dispatch({
            type: 'envModel/setDispatch',
            payload: dispatch
        })
        this.props.dispatch({
            type: 'envModel/getChartsData'
        })
    }
...
export default connect(mapStateToProps)(ENVLeftView);
