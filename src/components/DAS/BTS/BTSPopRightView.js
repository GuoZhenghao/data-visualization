...
import styles from './BTSPopRightView.less';

/**
 * 白塔寺右侧图表
 */
class BTSPopRightView extends React.Component {
    ...
    componentDidMount() {
        this.props.dispatch({
            type: 'btsModel/getPopChartsData'
        })
    }
...
export default connect(mapStateToProps)(BTSPopRightView);
